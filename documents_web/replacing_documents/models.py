...
class InstallDocumentRequest(models.Model):
    ...
    new_client_surname = models.TextField(blank=True, null=False, default='Пятигорская')
    replace_reason = models.TextField(blank=True, null=False, default='Вступление в брак')
